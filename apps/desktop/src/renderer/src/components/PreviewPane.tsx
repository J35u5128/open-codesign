  ...
  return (
    <div className={PREVIEW_PANE_LAYOUT_CLASSES.root}>
      <div className={PREVIEW_PANE_LAYOUT_CLASSES.stage}>
        ...
        >
          {/* INTEGRACIÓN NUEVO CANVAS */}
          {/* Sustituye el contenido central por el nuevo canvas-pane */}
          {/* body mantiene compatibilidad: si quieres alternar vista antigua/nueva, usa un flag aquí */}
          <CanvasPane />
        </div>
